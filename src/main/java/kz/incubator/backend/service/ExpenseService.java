...
import kz.incubator.backend.repo.ExpenseRepository;
...
public class ExpenseService extends BiDataService<ExpenseEntity, ExpenseDto> {
    ...
    @Override
    public ExpenseDto convertEntity(ExpenseEntity expenseEntity) {
        return new ExpenseDto()
                .setId(expenseEntity.getId())
                .setProject(convertProjectEntity(expenseEntity.getProjectEntity()))
