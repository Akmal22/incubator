...
import kz.incubator.backend.service.dto.user.ChangePasswordDto;
import kz.incubator.backend.service.dto.user.UserCredentials;
...
public class UserService implements UserDetailsService {
    ...
    public List<UserDto> getAllUsers(String filterText) {
        return userRepository.findAllByFilterText(filterText).stream()
                .map(Converter::convertUserEntity)
